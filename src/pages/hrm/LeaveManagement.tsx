...
const mockLeaves = [
  {
    id: 1,
    employee: 'Suyog Sutar',
    isCurrentUser: true,
    role: 'Web Developer',
    leaveDate: '10-01-2026 (Saturday)',
    duration: 'Full Day',
    status: 'Approved',
    type: 'Paid Leave (Monthly)',
  },
  {
    id: 2,
    employee: 'Suyog Sutar',
    isCurrentUser: true,
    role: 'Web Developer',
    leaveDate: '06-11-2025 (Thursday)',
    duration: 'Multiple (3 Days)',
    status: 'View Status',
  ...
  },
  {
    ...
    isCurrentUser: true,
    role: 'Web Developer',
    leaveDate: '05-11-2025 (Wednesday)',
    duration: 'Multiple (1 Day)',
    status: 'View Status',
    type: 'Paid Leave (Monthly)',
  },
  // ... other entries ...
...
export default function LeaveManagement() {
  ...
  const filteredLeaves = mockLeaves.filter(
    (leave) =>
      ...
      leave.leaveDate.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  const validateForm = () => {
    ...
    if (!formData.leaveType) newErrors.leaveType = 'Required';
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-900">
              <tr>
                <th
                  scope="col"
                  className="sticky left-0 z-10 bg-gray-50 dark:bg-gray-900 px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider border-r border-gray-200 dark:border-gray-700 min-w-[320px]"
                >
                  Employee
                </th>
                <th
                  scope="col"
                  className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider min-w-[200px]"
                >
                  Leave Date
                </th>
                <th
                ...
                <th
                  scope="col"
                  className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider min-w-[220px]"
                >
                  Type
                </th>
              ...
              {filteredLeaves.length === 0 ? (
                ...
                filteredLeaves.map((leave) => (
                  <tr key={leave.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors">
                    {/* Employee - sticky + wider + proper display */}
                    <td className="sticky left-0 z-10 bg-white dark:bg-gray-800 px-6 py-5 border-r border-gray-200 dark:border-gray-700 min-w-[320px]">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col min-w-0">
                          <div className="font-medium text-gray-900 dark:text-gray-100 flex items-center gap-2">
                            {leave.employee}
                            {leave.isCurrentUser && (
                              <span className="inline-flex px-2.5 py-0.5 text-xs font-medium bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 rounded-full flex-shrink-0">
                                You
                              </span>
                            )}
                          </div>
                    ...
                    <td className="px-6 py-5 whitespace-nowrap">
                      {leave.status === 'Approved' ? (
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-200 text-sm">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {errors.leaveType && <p className="mt-1.5 text-sm text-red-600">{errors.leaveType}</p>}
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none resize-y min-h-[100px] dark:bg-gray-700 dark:text-gray-100 ${
